const en = {
  ...
  "auth.login.description": "Sign in with your GitHub account",
  "auth.login.withGitHub": "Sign in with GitHub",
  "auth.login.signingIn": "Signing in...",
  "auth.login.backHome": "Back to Home",

  // auth callback
  "auth.callback.verifying": "Signing in...",
  "auth.callback.pleaseWait": "Please wait, completing sign in",
  "auth.callback.errorTitle": "Sign In Failed",
  "auth.callback.invalidLink": "Invalid authorization",
  "auth.callback.failed": "Sign in failed, please retry",
  "auth.callback.networkError": "Network error, please retry",
