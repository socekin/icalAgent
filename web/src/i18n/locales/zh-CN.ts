const zhCN = {
  ...
  "auth.login.description": "使用 GitHub 账户登录",
  "auth.login.withGitHub": "使用 GitHub 登录",
  "auth.login.signingIn": "登录中...",
  "auth.login.backHome": "返回首页",

  // auth callback
  "auth.callback.verifying": "正在登录...",
  "auth.callback.pleaseWait": "请稍候，正在完成登录",
  "auth.callback.errorTitle": "登录失败",
  "auth.callback.invalidLink": "无效的授权信息",
  "auth.callback.failed": "登录失败，请重试",
  "auth.callback.networkError": "网络错误，请重试",
  "auth.callback.backToLogin": "返回登录",
